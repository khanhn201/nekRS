...
#source /flare/Aurora_deployment/balin/Nek/nekRSv24/venv/_ssim_env/bin/activate
module list
...
#ntasks_tmp=12
#mpiexec -n 12 -ppn 12 --cpu-bind=list:0-7,104-111:8-15,112-119:16-23,120-127:24-31,128-135:32-39,136-143:40-47,144-151:52-59,156-163:60-67,164-171:68-75,172-179:76-83,180-187:84-91,188-195:92-99,196-203 -- ./affinity_nrs.sh 12 /flare/Aurora_deployment/balin/Nek/nekRSv24/exe/nekrsv24_simai_frameworks//bin/nekrs --setup ${case_tmp} --backend dpcpp --device-id 0  --build-only ${ntasks_tmp}
#if [ $? -ne 0 ]; then
#  exit
#fi
#date
