...
def main():
    ...
    parser.add_argument('--dbnodes', type=int, default=1, help='Number of database nodes')
    parser.add_argument('--device', type=str, default='cpu', choices=['cpu','cuda','xpu'], help='Device to run on')
    parser.add_argument('--ppn', type=int, default=1, help='Number of processes per node')
    parser.add_argument('--logging', type=str, default='no', choices=['no','verbose'], help='Level of performance logging')
